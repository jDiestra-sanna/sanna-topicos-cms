...
import AttendanceRecordEntryCampus from 'widgets/sanna/AttendanceRecordEntryCampus';
import * as attendanceRecordActions from 'app/store/actions/sanna/attendance-record.actions';
...
function Layout1(props) {
	...
	React.useEffect(() => {
		return () => {
			dispatch(attendanceRecordActions.resetState());
		}
	}, []);
