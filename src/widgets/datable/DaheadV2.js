...
class Dahead extends Component {
    ...
    constructor(props, context, state) {
        ...
        for (let field of this.fields) {
            ...
            if (field.type === 'select_ajax') {
                ...
                Api.get(field.endpoint, {limit: 500}, false)
                    .then(response => {
                        if (response.ok) {
                            let options = [];
    ...
    onChange = () => {
        if (this.props.onChange) {
            ...
            if (this.props.enableAutomaticSearch) {
    ...
    render() {
        ...
        return (
            <div className="flex flex-1 w-full items-center justify-between">
                                        ...
                                        <Typography component="div" style={{minWidth: field.width}} color="textPrimary">
                                            <Select
                                                ...
                                                options={prepareOptions(
                                                    field.items,
                                                    this.props.selectOptionDisabledColumn,
                                                    this.props.selectOptionDisabledValues
                                                )}
                                        ...
                                        <Typography component="div" style={{minWidth: field.width}} color="textPrimary">
                                            <AsyncSelect
                                                ...
                                                loadOptions={async (query, callback) => {
                                                    ...
                                                    const response = await Api.get(field.endpoint, param, false);
                                                    ...
                                                    if (response.ok) {
                                                        ...
                                                        callback(
                                                            prepareOptions(
                                                                data,
                                                                this.props.selectAjaxOptionDisabledColumn,
                                                                this.props.selectAjaxOptionDisabledValues
                                                            )
                                                        );
                                                    } else {
                                                        callback([]);
                                    ...
                                    <ThemeProvider theme={this.props.mainTheme}>
                                        <Typography component="div" style={{minWidth: field.width}} color="textPrimary">
                                            <Select
                                                ...
                                                options={prepareOptions(
                                                    this.state[kv + '_options'],
                                                    this.props.selectLocalOptionDisabledColumn,
                                                    this.props.selectLocalOptionDisabledValues
                                                )}
                                                value={this.state[kv]}
                                                isDisabled={disabled}
                                                onChange={o => {
                ...
                {!this.props.enableAutomaticSearch && (
                    <Button 
                        onClick={() => {
                            this.props.datable.current.reload();
                        }}
...
Dahead.propTypes = {
    ...
    enableAutomaticSearch: PropTypes.bool,
    ...
    selectOptionDisabledColumn: PropTypes.string,
    selectOptionDisabledValues: PropTypes.array,
    selectAjaxOptionDisabledColumn: PropTypes.string,
    selectAjaxOptionDisabledValues: PropTypes.array,
    selectLocalOptionDisabledColumn: PropTypes.string,
    selectLocalOptionDisabledValues: PropTypes.array,
};

Dahead.defaultProps = {
    selectOptionDisabledColumn: 'state',
    selectOptionDisabledValues: [0,2],
    selectAjaxOptionDisabledColumn: 'state',
    selectAjaxOptionDisabledValues: [0,2],
    selectLocalOptionDisabledColumn: 'state',
    selectLocalOptionDisabledValues: [0,2],
}
